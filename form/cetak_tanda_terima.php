  ...
  <table width="100%" cellspacing="30" cellpadding="30" align="center">
    <tr>
	  ...
	  <div id="print-area-1" class="print-area" style="width: 100%; padding: 0px;" align="center">
        <fieldset style="width: 100%; padding: 0px;" align="center">
        <!-- <legend>Cetak TT</legend> -->
        <table width="100%" border="0" cellpadding="5" cellspacing="5" bordercolor="1" style="border:solid 1px #000000; padding:0px;" align="center">
          <tr>
            ...
            <td width="21%" valign="bottom" align="right"><p>Jakarta, <?php echo date('Y-m-d');?></p></td>			
          </tr>
		  <tr>
			<td colspan="3" valign="top" align="right"><p>CN No : <?php echo $arrResult['no_cn']; ?></p></td>
		  </tr>
          <tr align="center">
            <td colspan="3" align="center"><strong><font size="+3" >CONSIGMENT NOTE</font></strong><hr></td>
          </tr>
          <tr>
		  ...
		  <tr>
            <td colspan="3"><table width="100%" border="1" cellpadding="5" cellspacing="5">
              <tr align="center">                
                <td width="25%" align="center">Coll</td>
                <td width="25%" align="center">Isi yang diberitahukan</td>
				<td width="25%" align="center">Dimensi Barang</td>
                <td width="25%" align="center">Berat</td>
              </tr>				
              <tr>
                <td align="center"><?php echo $arrResult['total_coll']; ?></td>
                <td align="center"><?php echo $arrResult['deskripsi_paket']; ?></td>
                <td align="center"><?php echo $arrResult['total_vol']; ?> Kg</td>
              ...
              <tr>
                <td colspan="2" rowspan="2" align="left" valign="top"><b>Ketentuan :</b><br>
                  ...
                  <b>3. Biaya bongkar muat diluar tanggung jawab pengangkut  </b>
				 </td>
